...
/*	var c = getElementsByClassName("tobe");*/
	...
	function goleft(x) {
		switch (x){
			case 1: {
						...
						curr=1;
						document.getElementById('butt1').style.backgroundColor="grey";
						document.getElementById('butt4').style.backgroundColor="blue";
						document.getElementById('butt3').style.backgroundColor="blue";
						document.getElementById('butt2').style.backgroundColor="blue";
						break;
					}
			case 2: {
						document.getElementById('opthree').style.float="left";
	...
	*/		
						curr=2;
						document.getElementById('butt2').style.backgroundColor="grey";
						document.getElementById('butt1').style.backgroundColor="blue";
						document.getElementById('butt3').style.backgroundColor="blue";
						document.getElementById('butt4').style.backgroundColor="blue";
						break;
					}
			case 3: {
						...
						curr=3;
						document.getElementById('butt3').style.backgroundColor="grey";
						document.getElementById('butt4').style.backgroundColor="blue";
						document.getElementById('butt2').style.backgroundColor="blue";
						document.getElementById('butt1').style.backgroundColor="blue";
						document.getElementById('pagefour').style.display="none";
	...
	function goright(x) {
		switch (x){
			...
			case 4: {
						...
						curr=4;
						document.getElementById('butt4').style.backgroundColor="grey";
						document.getElementById('butt1').style.backgroundColor="blue";
						document.getElementById('butt2').style.backgroundColor="blue";
						document.getElementById('butt3').style.backgroundColor="blue";
						break;
